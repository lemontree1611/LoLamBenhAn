...
function getFormData() {
  return {
    ...
    benhsu_tuongtrinh: getField('benhsu_tuongtrinh'),
    benhsu_hauphau: getField('benhsu_hauphau'),
...
<head>
  <meta charset="utf-8" />
  <title>BỆNH ÁN HẬU PHẪU - ${escapeHtml(data.hoten)}</title>
<style>
...
<body>
  <h1 class="center" style="margin:0 0 8px 0;font-size:20pt;"><b>BỆNH ÁN HẬU PHẪU</b></h1>
  ...
  <!-- ✅ các cơ quan đổi thành 3 -->
  <p style="margin-top:6px;"><b>3. Khám cơ quan:</b></p>
    ...
    const doc = new docx.Document({
      ...
      sections: [{
        ...
        children: [
          ...
          paraHeading("2. ", "Bệnh sử:", {}),

            paraHeading("", "Quá trình trước mổ", { spacing:{before:40} }),
